            ...
            <div class="row-main-content">
                ...
                <div class="row-body">
                    <div class="data-group">
                        <div class="data-item">
                            <span class="data-label" style="font-weight: 800;">FW Version</span>
                            <span class="data-val val-fw">${product.fw}</span>
                        </div>
                       <div class="data-item">
                            <span class="data-label" style="font-weight: 800;" title="${targetOS}">
...
// =========================================================
//  PART 7: 暗黑模式控制 (Dark Mode)
// =========================================================
const THEME_STORAGE_KEY = 'HCL_THEME_MODE';
...
function toggleTheme() {
    ...
    localStorage.setItem(THEME_STORAGE_KEY, newTheme); // 記憶使用者選擇
...
function updateThemeIcon(theme) {
    ...
    if (theme === 'dark') {
        ...
        btn.style.backgroundColor = '#f39c12'; // 太陽顏色 (橘黃)
        btn.title = "切換明亮模式";
    } else {
        btn.innerHTML = '<i class="fas fa-moon"></i>';
        btn.style.backgroundColor = '#2c3e50'; // 月亮顏色 (深藍)
        btn.title = "切換暗黑模式";
    }
}